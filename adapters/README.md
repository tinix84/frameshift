...
Each adapter directory contains a human-readable bootstrap and a capability manifest example. A production adapter must pass the conformance requirements in `specs/runtime-portability.md`.
