...
> Historical note: this report was originally prepared on branch
> `research/module-dependency-enforcement` for issue #36. It is retained here as
> research input; the repository's documentation authority map still assigns durable
> decisions to ADRs and definitions to `CONTEXT.md`.
